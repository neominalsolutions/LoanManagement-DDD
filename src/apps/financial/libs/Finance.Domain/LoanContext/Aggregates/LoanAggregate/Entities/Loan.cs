...
namespace Finance.Domain.LoanContext.Aggregates.LoanAggregate.Entities
{
  public class Loan : AggregateRoot
  {
    ...
    public IReadOnlyList<LoanDebt> Debts => _debts;


    public bool Closed { get; private set; } // Kredi Kapandı mı?


    public Loan(string loanApplicationId, Money principalAmount, string loadCustomerId, int term, double bankRate, string name)
    {
    ...
    // Not: Loan Debts loan ile birlikte kaydolmuyor Neden ?
    private void AddLoanDebts()
    {
